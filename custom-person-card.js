...
class CustomPersonCard extends HTMLElement {
  ...
  class CustomPersonCardEditor extends HTMLElement {
    set hass(hass) {
      this._hass = hass;
      // Pass hass down to the pickers so they can search
    ...
    render() {
      ...
      this.innerHTML = `
        <div style="display: flex; flex-direction: column; gap: 16px; padding: 16px;">
          ...
          <!-- Person Picker -->
          <div>
             <ha-entity-picker class="person-picker" label="Entity (Person)" allow-custom-entity></ha-entity-picker>
          </div>
  
          <!-- Battery Picker -->
          <div>
             <ha-entity-picker class="battery-picker" label="Battery Sensor" allow-custom-entity></ha-entity-picker>
          </div>
          ...
          <div style="display:flex; flex-direction:column;">
            ...
            <select class="layout-select" style="padding: 8px; border-radius: 4px; border: 1px solid var(--divider-color);">
      ...
      // --- Manually set properties via JS ---
      
      // 1. Entity Picker (Person)
      const entityPicker = this.querySelector(".person-picker");
      entityPicker.includeDomains = ["person"]; 
      ...
      if (this._hass) batteryPicker.hass = this._hass;
